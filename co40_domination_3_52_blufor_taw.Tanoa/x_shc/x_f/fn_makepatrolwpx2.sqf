...
private "_wp1";_cur_pos = _start_pos;
private "_wp1";_no_pos_found = false;
for "_i" from 0 to (2 + (floor (random 3))) do {
	private "_wp1";_wp_pos = switch (count _wp_array) do {
	...
	_cur_pos = _wp_pos;
	private "_wp1";_wp = _grp addWaypoint [_wp_pos, 0];
