class d_TeleportDialog {
	idd = -1;
	movingEnable = false;
	onLoad="uiNamespace setVariable ['d_TeleportDialog', param [0]];d_teleport_dialog_open = true;[param [0], 0] call d_fnc_teleportdialoginit";
	onUnLoad="uiNamespace setVariable ['d_TeleportDialog', nil];d_teleport_dialog_open = false";
