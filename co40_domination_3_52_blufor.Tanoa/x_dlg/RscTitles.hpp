...
class d_restrict {
	...
	name="d_restrict";
	class controls {
		class thetext: RscText2 {
			idc=50;
			style="16+2+512";
			lineSpacing=0.95;
			text="You are not allowed to monetize videos and streams made while playing Domination!!! If you want to make money make your own content @youtube and twitch heroes!!!!!! Server monetization in any form is also not allowed!!!";
			x=SafeZoneX;
			y=SafeZoneY + SafeZoneH - 0.03;
			w=SafeZoneW - 0.1;
			h=0.7;
			colorBackground[]={0,0,0,0};
			colorText[]={0.8,0.9,0.9,0.5};
			size=0.57;
			sizeEx = 0.024;
		};
	};
